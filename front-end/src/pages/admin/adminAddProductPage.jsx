...
return(
        <div className="w-full h-full flex flex-col bg-app-cream rounded-2xl shadow overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-5 sm:py-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 sm:gap-x-6 gap-y-5">
                    ...
                    <div className="flex flex-col">
                        <label className="font-semibold text-sm text-app-text mb-1.5 ml-0.5">Product ID :</label>
                        <input value={productId} onChange={(e)=>{setProductId(e.target.value)}} type="text" placeholder="Ex: ID001" className="border border-app-border rounded-lg h-11 sm:h-12 px-3.5 text-sm sm:text-base text-app-text bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition"/>
                    </div>
                    ...
                    <div className="flex flex-col sm:col-span-2">
                        <label className="font-semibold text-sm text-app-text mb-1.5 ml-0.5">Images :</label>
                        <input multiple type="file" onChange={(e)=>{setFiles(e.target.files)}} className="border border-app-border rounded-lg h-11 sm:h-12 px-3 py-2 text-sm text-app-text-light bg-white file:mr-3 file:px-3 file:py-1.5 file:rounded-md file:border-0 file:bg-primary file:text-white file:text-sm file:font-medium hover:file:bg-primary-dull file:cursor-pointer cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary transition"/>
                    </div>

                    <div className="flex flex-col">
                        <label className="font-semibold text-sm text-app-text mb-1.5 ml-0.5">Category :</label>
                        <select value={category} onChange={(e)=>{setCategory(e.target.value)}} className="border border-app-border rounded-lg h-11 sm:h-12 px-3.5 text-sm sm:text-base text-app-text bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition">
                    ...
                    <div className="flex flex-col">
                        <label className="font-semibold text-sm text-app-text mb-1.5 ml-0.5">Rating :</label>
                        <input value={rating} onChange={(e)=>{setRating(e.target.value)}} type="text" placeholder="Ex: 4.5" className="border border-app-border rounded-lg h-11 sm:h-12 px-3.5 text-sm sm:text-base text-app-text bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition"/>
                    </div>

                    <div className="flex flex-col">
                        <label className="font-semibold text-sm text-app-text mb-1.5 ml-0.5">Review Count :</label>
                        <input value={reviewCount} onChange={(e)=>{setReviewCount(e.target.value)}} type="text" placeholder="Ex: 100" className="border border-app-border rounded-lg h-11 sm:h-12 px-3.5 text-sm sm:text-base text-app-text bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition"/>
                    </div>

                    <div className="flex flex-col">
                        <label className="font-semibold text-sm text-app-text mb-1.5 ml-0.5">Is Available :</label>
                        <select value={isAvailable} onChange={(e)=>{setIsAvailable(e.target.value)}} className="border border-app-border rounded-lg h-11 sm:h-12 px-3.5 text-sm sm:text-base text-app-text bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary transition">
            ...
            <div className="w-full sticky bottom-0 bg-white border-t border-app-border rounded-b-2xl flex flex-col-reverse sm:flex-row justify-end items-stretch sm:items-center gap-3 p-4">
                <button onClick={()=> navigate("/admin/products")} className="bg-gray-200 text-app-text font-semibold px-6 py-2.5 sm:py-3 rounded-lg hover:bg-gray-300 transition">Cancel</button>
                <button onClick={handleAddProduct} className="bg-primary text-white font-semibold px-6 py-2.5 sm:py-3 rounded-lg hover:bg-primary-dull transition">Add Product</button>
            </div>
