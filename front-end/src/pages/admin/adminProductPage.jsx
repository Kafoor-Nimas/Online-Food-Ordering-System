        ...
        <div className="w-full bg-white rounded-2xl shadow-lg shadow-app-green/5 border border-app-border overflow-hidden">
          {loading ? (
            ...
            <div className="w-full py-24 flex flex-col justify-center items-center text-center">
              <p className="text-lg font-medium text-app-green">
                No products yet
              </p>
              ...
              <table className="w-full border-collapse text-sm">
                ...
                <thead>
                  <tr className="bg-app-green text-app-cream">
                    <th className="px-5 py-4 text-left text-xs font-semibold tracking-wider uppercase whitespace-nowrap">
                      Product ID
                    </th>
                    <th className="px-5 py-4 text-left text-xs font-semibold tracking-wider uppercase whitespace-nowrap">
                      Name
                    </th>
                    <th className="px-5 py-4 text-left text-xs font-semibold tracking-wider uppercase">
                      Description
                    </th>
                    <th className="px-5 py-4 text-left text-xs font-semibold tracking-wider uppercase whitespace-nowrap">
                      Price
                    ...
                    <th className="px-5 py-4 text-center text-xs font-semibold tracking-wider uppercase whitespace-nowrap">
                      Actions
                    </th>
                  </tr>
                </thead>
                ...
                <tbody className="text-app-text divide-y divide-app-border">
                  {products.map((item, index) => {
                    return (
                      ...
                      >
                        <td className="px-5 py-4 whitespace-nowrap text-app-text-light">
                          #{item.productId || index + 1}
                        </td>
                        <td className="px-5 py-4 font-medium text-app-green whitespace-nowrap">
                          {item.name}
                        </td>
                        <td className="px-5 py-4 max-w-xs truncate text-app-text-light">
                          {item.description}
                        </td>
                        ...
                        <td className="px-5 py-4">
                          {item.images && item.images[0] ? (
                            ...
                            <span className="text-app-text-light text-xs italic">
                              No image
                            </span>
                          )}
                        </td>
                        ...
                        <td className="px-5 py-4">
                          <div className="flex justify-center items-center">
                            <Link
                              ...
                              state={item}
                              className="w-9 h-9 flex items-center justify-center rounded-full text-orange-500 hover:text-orange-600 hover:bg-orange-100 transition-colors"
                              title="Edit product"
                            >
